...
## 10. Сравнение с Samsung FIT Plus (замеры сделаны)

Носитель **куплен и протестирован** (см. раздел 2). Samsung FIT Plus — тоже
`usb-storage` BOT, без UAS и TRIM, но **значительно быстрее AGI** во всех
тестах. Ниже — оставшийся план: перенос системы и критерий suspend.
...
- **Открытый план:** Samsung FIT Plus **протестирован** (раздел 2): быстрее AGI
  во всём (особенно случ. запись ×29). Осталось решить — переносить ли систему
  на Samsung (раздел 10) и проверить suspend на нём.
