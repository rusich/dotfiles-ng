...
local spec = {
  ...
  opts = {
    ...
    dashboard = {
      ...
      preset = {
        header = [[
_______  _______  ___      _______  ___   _  _______  _______  _______  _______  __    _        __    _  __   __  ___   __   __
|       ||       ||   |    |       ||   | | ||   _   ||       ||       ||       ||  |  | |      |  |  | ||  | |  ||   | |  |_|  |
|_     _||    ___||   |    |    ___||   |_| ||  |_|  ||  _____||_     _||    ___||   |_| |      |   |_| ||  |_|  ||   | |       |
  |   |  |   |___ |   |    |   |___ |      _||       || |_____   |   |  |   |___ |       |      |       ||       ||   | |       |
  |   |  |    ___||   |___ |    ___||     |_ |       ||_____  |  |   |  |    ___||  _    | ___  |  _    ||       ||   | |       |
  |   |  |   |___ |       ||   |___ |    _  ||   _   | _____| |  |   |  |   |___ | | |   ||   | | | |   | |     | |   | | ||_|| |
  |___|  |_______||_______||_______||___| |_||__| |__||_______|  |___|  |_______||_|  |__||___| |_|  |__|  |___|  |___| |_|   |_|]]
        ,
        keys = {
