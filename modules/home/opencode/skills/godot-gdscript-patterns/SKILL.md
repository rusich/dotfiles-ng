...
description: Copy-paste GDScript implementations of core Godot 4 patterns — state machine, event bus, autoload singletons, resource-based data, object pooling, hitbox/hurtbox components, async scene manager, encrypted save system. Use when you need ready-made, self-contained code for one of these specific patterns. For architecture decisions, genre blueprints, performance budgets, or project-wide workflows use godot-master instead.
---
